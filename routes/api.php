...
Route::post('/productsUpdate/{id}',[\App\Http\Controllers\ProductController::class, 'update']);
...
Route::post('/brandsUpdate/{id}',[\App\Http\Controllers\BrandController::class, 'update']);
